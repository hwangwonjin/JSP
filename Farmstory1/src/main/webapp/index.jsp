            ...
            <div class="latest">
                <div>
                    ...
                    %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/board/view.jsp?group=captalk&cate=grow&no=<%= ab.getNo()%>&pg=1"><%= ab.getTitle() %></a></td>
                            <td>20-12-22</td>
                        </tr>
                    	<%} %>
                    </table>
                ...
                <div>
                    ...
                    %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/board/view.jsp?group=captalk&cate=school&no=<%= ab.getNo()%>&pg=1"><%= ab.getTitle() %></a></td>
                            <td>20-12-22</td>
                        </tr>
                    	<%} %>
                    </table>
                ...
                <div>
                    ...
                    %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/board/view.jsp?group=captalk&cate=story&no=<%= ab.getNo()%>&pg=1"><%= ab.getTitle() %></a></td>
                            <td>20-12-22</td>
                        </tr>
                    	<%} %>
                    </table>
            ...
            <div class="info">
                ...
                <div>
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                            <ul class="txt txt-notice">
                            </ul>
                        </div>
                        <div id="tabs-2">
                            <ul class="txt txt-qna">
                            </ul>
                        </div>
                        <div id="tabs-3">
