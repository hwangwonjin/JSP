...
<jsp:include page="./_header.jsp"></jsp:include>
 <script >
        ...
        <main>
            ...
            <div class="quick">
                <a href="./board/list.do?group=croptalk&cate=grow">
                <img src="./img/main_banner_sub1_tit.png" alt="오늘의 식단"></a>
                <a href="#">
                <img src="./img/main_banner_sub2_tit.png" alt="나도 요리사"></a>                
            </div>

            <div class="latest">
                <div>
                    <a href="./board/list.do?group=croptalk&cate=grow">
                    <img src="./img/main_latest1_tit.png" alt="텃밭 가꾸기"/></a>
                    <img src="./img/main_latest1_img.jpg" alt="이미지"/>
                    <table border="0">
                    	<c:forEach var="latests" items="${latests}">
                    		<c:if test="${latests.cate eq 'grow'}">
		                        <tr>
		                            <td>></td>
		                            <td><a href="/Farmstory2/board/view.do?group=cropstalk&cate=grow&pg=1&no=${latests.no}">${latests.title}</a></td>
		                            <td>${latests.rdate}</td>
		                        </tr>
	                        </c:if>
                      	</c:forEach>
                ...
                <div>
                    <a href="./board/list.do?group=croptalk&cate=school">
                    <img src="./img/main_latest2_tit.png" alt="귀농학교"/></a>
                    <img src="./img/main_latest2_img.jpg" alt="이미지"/>
                    <table border="0">
                    	<c:forEach var="latests" items="${latests}">
                    		<c:if test="${latests.cate eq 'school'}">
		                        <tr>
		                            <td>></td>
		                            <td><a href="/Farmstory2/board/view.do?group=cropstalk&cate=school&pg=1&no=${latests.no}">${latests.title}</a></td>
		                            <td>${latests.rdate}</td>
		                        </tr>
                      		</c:if>
                      </c:forEach>
                ...
                <div>
                    <a href="./board/list.do?group=croptalk&cate=story">
                    <img src="./img/main_latest3_tit.png" alt="농작물 이야기"/></a>
                    <img src="./img/main_latest3_img.jpg" alt="이미지"/>
                    <table border="0">
                      <c:forEach var="latests" items="${latests}">
                    		<c:if test="${latests.cate eq 'story'}">
		                        <tr>
		                            <td>></td>
		                            <td><a href="/Farmstory2/board/view.do?group=cropstalk&cate=story&pg=1&no=${latests.no}">${latests.title}</a></td>
		                            <td>${latests.rdate}</td>
		                        </tr>
                      		</c:if>
                      </c:forEach>
